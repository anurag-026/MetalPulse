// Mock Market Data - Centralized location for all market mock data
// This file contains all mock data related to market information, charts, and analytics
...
export const MOCK_MARKET_NEWS = [
  {
    ...
    summary: "Strong demand from central banks and geopolitical tensions drive gold prices higher",
    impact: "positive",
  ...
  },
  {
    ...
    summary: "Growing solar panel and electric vehicle production boosts silver demand",
    impact: "positive",
